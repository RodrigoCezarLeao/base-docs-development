...
public class TemperatureReadingsControllerTests : IClassFixture<ApiFactory>
{
    ...
    public async Task GET_All_Returns200WithPagedData()
    {
        ...
        _repository.GetPagedAsync(1, 10, Arg.Any<CancellationToken>())
            .Returns((readings.AsEnumerable(), 1));
    ...
    public async Task GET_ById_WhenExists_Returns200()
    {
        _repository.GetByIdAsync(1, Arg.Any<CancellationToken>())
            .Returns(MakeReading(1, "Brasília", 26m));
    ...
    {
        _repository.CreateAsync(Arg.Any<TemperatureReading>(), Arg.Any<CancellationToken>())
            .Returns(10);
    ...
    {
        _repository.GetByIdAsync(1, Arg.Any<CancellationToken>())
            .Returns(MakeReading(1, "SP", 28m));
        _repository.UpdateAsync(Arg.Any<TemperatureReading>(), Arg.Any<CancellationToken>())
            .Returns(true);
